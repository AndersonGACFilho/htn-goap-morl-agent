...
\begin{tikzpicture}[
    ...
    \node[control, below=of replan] (tasks) {Agente fornece a cópia\\
        das tarefas-raiz};
    \node[symbolic, below=of tasks] (strategy) {Planner ordena métodos viáveis\\
    ...
    \draw[arrow, fallbackorange] (replan) -- (tasks);
    \draw[arrow, htnblue] (tasks) -- (strategy);
\end{tikzpicture}
...
Ao replanejar, o agente fornece sua cópia das tarefas-raiz; o planner aplica a
estratégia configurada para ordenar apenas os métodos já viáveis.}
