...
\begin{tikzpicture}[
  ...
  \node[draw=black!45, rounded corners=1.5mm, align=left, font=\scriptsize,
    ...
    HTN define validade e decomposição; a fonte fornece preferências; MORL
    ranqueia apenas métodos válidos. A recuperação por falha é excepcional e
    não corresponde ao caminho normal da decisão online.};
\end{tikzpicture}
\end{document}
