...
\begin{itemize}
\item implementar perfis fixos e regras explícitas como baselines;
\item implementar e validar o codificador relacional de preferências;
\item validar normalização, mudanças contextuais e condições de teste.
\end{itemize}
...
\item validar o ciclo online HTN--codificador de preferências--MORL;
\item decidir, com base nos resultados e no orçamento, se um codificador
profundo deve ser incluído.
\end{itemize}
