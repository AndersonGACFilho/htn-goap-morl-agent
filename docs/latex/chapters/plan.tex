...
válido; um codificador de preferências fornece $\mathbf{w}_t$ para expressar o
compromisso vigente; e o MORL escolhe qual método HTN válido deve decompor a
tarefa composta corrente.
O codificador é comparado como módulo auxiliar, e não como uma camada de
...
escolha de métodos HTN sem perder a validade semântica, a interpretabilidade e
o controle de designer fornecidos pelo planejamento simbólico.
...
O codificador de grafo é a primeira alternativa
estrutural; o codificador profundo é condicional aos resultados, aos dados e ao
orçamento experimental disponíveis.
