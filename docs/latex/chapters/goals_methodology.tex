...
de preferência.
A ação será a escolha direta de um único método. O treinamento poderá explorar
decomposições e episódios completos offline para aprender os valores vetoriais
das alternativas; durante a execução online, a decisão deverá ser uma inferência
mascarada em cada ponto de seleção HTN, seguida da decomposição apenas do método
escolhido.
...
os métodos. Mudanças do mundo durante a execução exigem replanejamento a partir
do estado observado.
